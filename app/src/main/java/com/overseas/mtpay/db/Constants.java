...
//    public static final String DEFAULT_PORT = "8080";
    ...
    public static final String ALIPAYFLAG2 = "2";
    public static final String WEPAYFLAG2 = "1";

    public final static boolean WIZARPOS_FLAG = true;//是否是慧银机具
    public final static boolean DZXPAD_FLAG = false;//是否是大屏机
    ...
    public static int getIntValue(String APP_VERSION_NAME) {
        return Integer.valueOf(AppConfigHelper.getConfig(APP_VERSION_NAME,"0"));
    }
...
//        DEBUGING = isTrue(AppConfigDef.DEBUGING); //调试模式 默认 false
    ...
    public static int getIntVersion(String configName) {
        if (App.getInstance().getDbController() != null) {
...
//        TRAN_TYPE.put(SC_809_CANCEL_ALIPAY, "Alipay" + " " + PaymentApplication.getInstance().getString(R.string.refund_tag));
        ...
        TRAN_TYPE.put("913", "Alipay");
        TRAN_TYPE.put("909", "Alipay");//913支付宝交易909支付宝交易撤销
    }
