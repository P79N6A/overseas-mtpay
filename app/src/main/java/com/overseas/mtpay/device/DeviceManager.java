package com.overseas.mtpay.device;
...
//        }
        ...
        // 耗时操作
//        AsyncTask<BasePresenter.ResultListener, Void, String> task = new AsyncTask<BasePresenter.ResultListener, Void, String>() {
//            private BasePresenter.ResultListener listener;
//
//            @Override
//            protected String doInBackground(BasePresenter.ResultListener... params) {
